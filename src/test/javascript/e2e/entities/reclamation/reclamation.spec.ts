...
describe('Reclamation e2e test', () => {
  ...
  it('should load Reclamations', async () => {
    ...
    expect(await reclamationComponentsPage.getTitle()).to.eq('timesuponlineApp.reclamation.home.title');
    await browser.wait(
  ...
  it('should load create Reclamation page', async () => {
    ...
    expect(await reclamationUpdatePage.getPageTitle()).to.eq('timesuponlineApp.reclamation.home.createOrEditLabel');
  ...
  it('should create and save Reclamations', async () => {
    ...
    await promise.all([
      reclamationUpdatePage.etatSelectLastOption(),
      reclamationUpdatePage.auteurSelectLastOption(),
      reclamationUpdatePage.motSelectLastOption()
    ]);
  ...
  it('should delete last Reclamation', async () => {
    ...
    expect(await reclamationDeleteDialog.getDialogTitle()).to.eq('timesuponlineApp.reclamation.delete.question');
