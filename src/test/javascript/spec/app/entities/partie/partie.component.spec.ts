...
import { PartieComponent } from 'app/entities/partie/partie.component';
import { PartieService } from 'app/entities/partie/partie.service';
import { Partie } from 'app/shared/model/partie.model';

describe('Component Tests', () => {
  describe('Partie Management Component', () => {
    let comp: PartieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PartieComponent, '')
        .compileComponents();
