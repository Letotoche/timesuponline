...
/**
 * REST controller for managing {@link com.letotoche.timesuponline.domain.Equipe}.
 */
@RestController
@RequestMapping("/api")
public class EquipeResource {
     ...
     */
    @GetMapping("/equipes")
    public ResponseEntity<List<Equipe>> getAllEquipes(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
